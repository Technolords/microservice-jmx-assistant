...
public class OutputRoute extends RouteBuilder {
    ...
    public void configure() throws Exception {
        from(ROUTE_ENDPOINT)
                .routeId(ROUTE_ID)
                .id(ROUTE_ID)
                .log(LoggingLevel.INFO, LOGGER, "Directing to output...")
                .choice()
                .when(this.filePredicate)
                    .log(LoggingLevel.INFO, LOGGER, "Output to file...")
                    .process(this.fileProcessor)
                    .id(MARKER_FOR_FILE)
                .when(this.redisPredicate)
                    .log(LoggingLevel.INFO, LOGGER, "Output to redis...")
                    .process(this.redisProcessor)
                    .id(MARKER_FOR_REDIS)
                .otherwise()
                    .log(LoggingLevel.INFO, LOGGER, "Output to log..")
